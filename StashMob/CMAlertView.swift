...
protocol CMAlertViewProtocol {
    ...
    func addButtons(buttonArray:[CMBaseButton])
    func removeButtons()
    func present()
    func dismiss()
    func layoutIfNeeded()
...
class CMAlertView: UIView, CMAlertViewProtocol {
    ...
    internal var textToButtonsPadding:CGFloat            = 35
    internal var titleTopPadding:CGFloat                 = 30
    internal var messageTopPadding:CGFloat               = 20
    internal var buttonHeight:CGFloat                    = 55
    ...
    func didLoad() {
        ...
        self.titleLabel?.textColor              = UIColor.redCurrent()
        self.titleLabel?.numberOfLines          = 0
        
        self.messageLabel?.font                 = UIFont.systemFontOfSize(18)
        self.messageLabel?.textColor            = UIColor.blackCurrent()
    ...
    func addData(titleString:String, messageString:String) {
        ...
        if titleString.characters.count == 0 {
            ...
            self.titleLabelHeight!.constant     = titleString.heightWithConstrainedWidth(CGFloat(self.widthConstraint!.constant - self.doubleTextFieldHorizontalPadding), font: self.titleLabel!.font)
        ...
        if messageString.characters.count == 0 {
            ...
            self.messageLabelHeightConstraint!.constant = titleString.heightWithConstrainedWidth(CGFloat(self.widthConstraint!.constant - self.doubleTextFieldHorizontalPadding), font: self.messageLabel!.font)
